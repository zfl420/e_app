...
export const CHAT_THREADS: ChatThread[] = [
  ...
  { id: 'store5', name: '上海博世汽配专营店', avatar: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=150&h=150&fit=crop&q=80', time: '12/01', lastMessage: '好的，马上安排发货' },
  { id: 'store6', name: '杭州美孚润滑油总代理', avatar: 'https://images.unsplash.com/photo-1500648767791-00dcc994a43e?w=150&h=150&fit=crop&q=80', time: '12/01', lastMessage: '价格已确认，可以下单' },
  { id: 'store7', name: '深圳嘉实多授权经销商', avatar: 'https://images.unsplash.com/photo-1494790108377-be9c29b29330?w=150&h=150&fit=crop&q=80', time: '11/30', lastMessage: '库存充足，随时可以发货' },
  { id: 'store8', name: '北京TRW刹车片供应商', avatar: 'https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?w=150&h=150&fit=crop&q=80', time: '11/29', lastMessage: '[商品] 前刹车片现货' },
  { id: 'store9', name: '广州曼牌滤清器专营', avatar: 'https://images.unsplash.com/photo-1506794778202-cad84cf45f1d?w=150&h=150&fit=crop&q=80', time: '11/28', lastMessage: '三滤套装优惠价228元' },
  { id: 'store10', name: '成都瓦尔塔电池总代', avatar: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=150&h=150&fit=crop&q=80', time: '11/28', lastMessage: '12V 60Ah 有现货' },
  { id: 'store11', name: '苏州马勒滤清器代理', avatar: 'https://images.unsplash.com/photo-1500648767791-00dcc994a43e?w=150&h=150&fit=crop&q=80', time: '11/27', lastMessage: '空气滤芯已到货' },
  { id: 'store12', name: '武汉壳牌机油经销商', avatar: 'https://images.unsplash.com/photo-1494790108377-be9c29b29330?w=150&h=150&fit=crop&q=80', time: '11/26', lastMessage: '5W-40 全合成机油特价' },
  { id: 'store13', name: '南京菲罗多刹车片专营', avatar: 'https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?w=150&h=150&fit=crop&q=80', time: '11/25', lastMessage: '前后片套装598元' },
  { id: 'store14', name: '重庆道达尔润滑油代理', avatar: 'https://images.unsplash.com/photo-1506794778202-cad84cf45f1d?w=150&h=150&fit=crop&q=80', time: '11/24', lastMessage: '快驰9000 5W-30 有货' },
];
...
export const SAMPLE_CHAT_HISTORY: ChatMessage[] = [
  ...
  { id: 'm8', text: '价格是多少？', isMe: true, time: '10:38', type: 'text' },
  { id: 'm9', text: '前刹车片一套388元，后刹车片一套268元，不含税价格', isMe: false, time: '10:39', type: 'text' },
  { id: 'm10', text: '可以优惠一点吗？', isMe: true, time: '10:40', type: 'text' },
  { id: 'm11', text: '如果您一次性购买前后套包，我可以给您优惠价598元', isMe: false, time: '10:41', type: 'text' },
  { id: 'm12', text: '好的，那我要前后套包', isMe: true, time: '10:42', type: 'text' },
  { id: 'm13', text: '好的，马上为您安排。另外还有机油需要吗？我们新到了美孚1号全合成机油', isMe: false, time: '10:43', type: 'text' },
  { id: 'm14', text: '机油暂时不需要，先要刹车片', isMe: true, time: '10:44', type: 'text' },
  { id: 'm15', text: '没问题，订单已生成，预计今天下午4点前发货，明天上午可以到货', isMe: false, time: '10:45', type: 'text' },
  { id: 'm16', text: '好的，谢谢', isMe: true, time: '10:46', type: 'text' },
  { id: 'm17', text: '不客气，有任何问题随时联系我', isMe: false, time: '10:46', type: 'text' },
];
...
// 活动商品数据
export const TIRE_PRODUCTS: ProductItem[] = [
  {
    id: 'tire_1',
    title: '应诺 B102010610	205/55R16 94V EL316',
    image: 'https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=300&h=300&fit=crop&q=80',
    tags: ['应诺', '205/55R16', '94V'],
    price: '159.00',
    priceNoTax: '140.71',
    promo: '特价',
    volume: '1条',
    ...
    brand: '应诺',
    specs: '205/55R16 94V',
    applicableModels: ['大众', '丰田', '本田'],
  },
  {
    id: 'tire_2',
    title: '普利司通 轮胎 195/65R15 91H 泰然者 T001',
    image: 'https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=300&h=300&fit=crop&q=80',
    tags: ['普利司通', '195/65R15', '泰然者'],
    price: '388.00',
    priceNoTax: '343.36',
    promo: '热销',
    volume: '1条',
  ...
  {
    id: 'tire_3',
    title: '固特异 轮胎 215/60R16 95V 御乘 EfficientGrip',
    image: 'https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=300&h=300&fit=crop&q=80',
    tags: ['固特异', '215/60R16', '御乘'],
    price: '528.00',
    priceNoTax: '467.26',
    promo: '',
    volume: '1条',
  ...
  {
    id: 'tire_4',
    title: '马牌 轮胎 225/50R17 98Y 舒适型 CC6',
    image: 'https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=300&h=300&fit=crop&q=80',
    tags: ['马牌', '225/50R17', '舒适型'],
    price: '688.00',
    priceNoTax: '609.29',
    promo: '活动',
    volume: '1条',
  ...
  {
    id: 'tire_5',
    title: '倍耐力 轮胎 235/45R18 94Y 新P7 Cinturato P7',
    image: 'https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=300&h=300&fit=crop&q=80',
    tags: ['倍耐力', '235/45R18', '新P7'],
    price: '888.00',
    priceNoTax: '786.73',
    promo: '热销',
    volume: '1条',
...
export const WIPER_PRODUCTS: ProductItem[] = [
  {
    id: 'wiper_1',
    title: '博世 雨刮片 前雨刮 24+18寸 适配大众/丰田/本田',
    image: 'https://images.unsplash.com/photo-1605559424943-b3c52d41c373?w=300&h=300&fit=crop&q=80',
    tags: ['博世', '前雨刮', '24+18寸'],
    price: '88.00',
    priceNoTax: '77.88',
    promo: '活动',
  ...
  {
    id: 'wiper_2',
    title: '法雷奥 雨刮片 前雨刮 26+20寸 适配通用/福特/现代',
    image: 'https://images.unsplash.com/photo-1605559424943-b3c52d41c373?w=300&h=300&fit=crop&q=80',
    tags: ['法雷奥', '前雨刮', '26+20寸'],
    price: '128.00',
    priceNoTax: '113.27',
    ...
    brand: '法雷奥',
    specs: '26+20寸',
    applicableModels: ['通用', '福特', '现代'],
  },
  {
    id: 'wiper_3',
    title: '3M 雨刮片 前雨刮 22+16寸 适配日系车',
    image: 'https://images.unsplash.com/photo-1605559424943-b3c52d41c373?w=300&h=300&fit=crop&q=80',
    tags: ['3M', '前雨刮', '22+16寸'],
    price: '98.00',
    priceNoTax: '86.73',
...
export const ACTIVITY_BRAKE_PAD_PRODUCTS: ProductItem[] = [
  {
    id: 'brake_pad_1',
    title: '博世 刹车片 前片 适配大众朗逸/帕萨特 0986AB1234',
    image: 'https://images.unsplash.com/photo-1605559424943-b3c52d41c373?w=300&h=300&fit=crop&q=80',
    tags: ['博世', '前片', '低金属'],
    price: '168.00',
    priceNoTax: '148.67',
  ...
  {
    id: 'brake_pad_2',
    title: '菲罗多 刹车片 前片 适配本田雅阁/思域 FDB1234',
    image: 'https://images.unsplash.com/photo-1605559424943-b3c52d41c373?w=300&h=300&fit=crop&q=80',
    tags: ['菲罗多', '前片', '低粉尘'],
    price: '268.00',
    priceNoTax: '237.17',
  ...
  {
    id: 'brake_pad_3',
    title: 'TRW 刹车片 前片 适配大众朗逸/帕萨特 低金属配方',
    image: 'https://images.unsplash.com/photo-1605559424943-b3c52d41c373?w=300&h=300&fit=crop&q=80',
    tags: ['TRW', '前片', '低金属'],
    price: '228.00',
    priceNoTax: '201.77',
  ...
  {
    id: 'brake_pad_5',
    title: '开思严选 陶瓷刹车片 前片 适配大众速腾/高尔夫7',
    image: 'https://images.unsplash.com/photo-1605559424943-b3c52d41c373?w=300&h=300&fit=crop&q=80',
    tags: ['开思严选', '前片', '陶瓷配方'],
    price: '198.00',
    priceNoTax: '175.22',
...
export const ACTIVITY_OIL_PRODUCTS: ProductItem[] = [
  {
    id: 'oil_1',
    title: '美孚 美孚1号 金装 0W-40 全合成机油 1L 装 经典表现',
    image: 'https://images.unsplash.com/photo-1612815154858-60aa4c59eaa3?w=300&h=300&fit=crop&q=80',
    tags: ['0W-40', '全合成机油', '国行/大陆'],
    price: '67.50',
    priceNoTax: '60.00',
    promo: '秒杀',
  ...
  {
    id: 'oil_2',
    title: '嘉实多 极护 钛流体 0W-20 SP 1L 全合成机油',
    image: 'https://images.unsplash.com/photo-1612815154858-60aa4c59eaa3?w=300&h=300&fit=crop&q=80',
    tags: ['0W-20', '全合成机油', '进口/马来西亚'],
    price: '44.68',
    priceNoTax: '43.80',
  ...
  {
    id: 'oil_3',
    title: '壳牌 超凡喜力 5W-40 全合成机油 1L 装 灰壳',
    image: 'https://images.unsplash.com/photo-1612815154858-60aa4c59eaa3?w=300&h=300&fit=crop&q=80',
    tags: ['5W-40', '全合成机油', '德国进口'],
    price: '58.00',
    priceNoTax: '51.33',
  ...
  {
    id: 'oil_4',
    title: '道达尔 快驰9000 5W-30 全合成机油 1L 装',
    image: 'https://images.unsplash.com/photo-1612815154858-60aa4c59eaa3?w=300&h=300&fit=crop&q=80',
    tags: ['5W-30', '全合成机油', '法国进口'],
    price: '42.00',
    priceNoTax: '37.17',
  ...
  {
    id: 'oil_5',
    title: '长城 金吉星 J700 5W-30 全合成机油 1L 装',
    image: 'https://images.unsplash.com/photo-1612815154858-60aa4c59eaa3?w=300&h=300&fit=crop&q=80',
    tags: ['5W-30', '全合成机油', '国产品牌'],
    price: '35.00',
    priceNoTax: '30.97',
...
// 将活动商品合并到现有分类中（如果ID不冲突）
// 活动刹车片和汽机油商品使用不同的ID前缀，所以可以安全合并
const allBrakePadProducts = [...BRAKE_PAD_PRODUCTS, ...ACTIVITY_BRAKE_PAD_PRODUCTS];
const allOilProducts = [...OIL_PRODUCTS, ...ACTIVITY_OIL_PRODUCTS];

export const CATEGORY_PRODUCT_MAP: Record<string, ProductItem[]> = {
  oil: allOilProducts,
  battery: BATTERY_PRODUCTS,
  brake_pad: allBrakePadProducts,
