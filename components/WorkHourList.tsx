...
const WorkHourList: React.FC<WorkHourListProps> = ({ onBack, appVersion, onVersionChange, onAdminClick }) => {
    ...
    <div className="flex flex-col h-screen bg-gray-50">
      ...
      <div className="flex-1 overflow-y-auto bg-gray-50 pb-6">
        <div className="px-4 pt-4">
          <div className="text-sm text-gray-600 mb-3">项目列表 ({filteredWorkHours.length}项)</div>
